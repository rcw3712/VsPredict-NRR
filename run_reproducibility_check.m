...
% Provenance class
log('Provenance class identical and corrected',...
    strcmp(r1.deploy.provenance,r2.deploy.provenance)&&...
    any(strcmp(r1.deploy.provenance,{'PED_CORRECTED_FULL_REANALYSIS','V5_CORRECTED_REANALYSIS'})));
